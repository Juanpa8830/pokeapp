...
/***/ "./src/modules/pokedexReserve.js":
/*!***************************************!*\
  !*** ./src/modules/pokedexReserve.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ pokedexReserve)\n/* harmony export */ });\n/* harmony import */ var _getData_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getData.js */ \"./src/modules/getData.js\");\n/* harmony import */ var _pokemondata_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pokemondata.js */ \"./src/modules/pokemondata.js\");\n/* harmony import */ var _popupReserve_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./popupReserve.js */ \"./src/modules/popupReserve.js\");\n/* harmony import */ var _reserveCounter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reserveCounter.js */ \"./src/modules/reserveCounter.js\");\n\n\n\n\n\nconst url = 'https://pokeapi.co/api/v2/ability/';\n\nasync function pokedexReserve(id) {\n  const api = new _pokemondata_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n  const pokemons = await api.getmultiplePokemon(1, 20);\n  const data = await (0,_getData_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(`${url}${id}`);\n  const description = data.effect_entries[1].effect;\n  const allReserves = await (0,_reserveCounter_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(id);\n  for (let i = 0; i < pokemons.length; i += 1) {\n    if (pokemons[i].id === parseInt(id, 10)) {\n      (0,_popupReserve_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(pokemons[i].image, pokemons[i].name, description, allReserves);\n      break;\n    }\n  }\n}\n\n//# sourceURL=webpack://pokeapp/./src/modules/pokedexReserve.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ reserveCounter)\n/* harmony export */ });\n/* harmony import */ var _involvementAPI_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./involvementAPI.js */ \"./src/modules/involvementAPI.js\");\n\n\nasync function reserveCounter(id) {\n  const allReserves = await _involvementAPI_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getReserve(id);\n  if (allReserves !== 400) {\n    return allReserves;\n  }\n  return [];\n}\n\n//# sourceURL=webpack://pokeapp/./src/modules/reserveCounter.js?");

/***/ }),

/***/ "./src/modules/reserveCounterDOM.js":
/*!******************************************!*\
  !*** ./src/modules/reserveCounterDOM.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ reserveCounterDOM)\n/* harmony export */ });\nfunction reserveCounterDOM() {\n  const userReservation = document.querySelectorAll('.user-reserves');\n  if (userReservation.length !== 0) {\n    return userReservation.length;\n  }\n  return 0;\n}\n\n//# sourceURL=webpack://pokeapp/./src/modules/reserveCounterDOM.js?");
